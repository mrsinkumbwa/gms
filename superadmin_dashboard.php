...
<body>
    ...
    <nav class="sidenav">
        <a href="service_providers.php" target="">Service Providers</a>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $(".sidenav a").click(function(event) {
                ...
                // Load the content of the linked page into the main-content div using fetch()
